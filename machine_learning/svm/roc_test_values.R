...
#models = c("RSA_WCN_SS_Mean_Score")
...
for (i in 1:num_files){
  ...
  for (j in 1:num_samples){
    ...
    #roc_filename = paste("../../svn/roc_curve_data/", model_type, ".csv", sep = "")
    #write.csv(ROC_test, roc_filename)
  #paste()
  }
}
#print(Test_AUC_Values)
write.csv(Test_AUC_Values, "../../data/svm_auc_cross_validated.csv")
...
write.csv(summarized_auc, "../../data/svm_summarized_auc_cross_validated.csv")
